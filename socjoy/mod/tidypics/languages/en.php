...
return [
	...
	'images:upload' => "Upload joys to this album",

	'collection:object:album' => "Joy albums",
	'collection:object:album:owner' => "%s's joy albums",
	'collection:object:album:group' => "Group joy albums",
	'sort:object:album' => 'Sorting the %s album',
	'add:object:album' => "What's your joy about?",
	...
	'add:object:image' => "Add joys to album",
	...
	'collection:object:album:all' => "All joy albums",
	...
	'album:yours:friends' => "Your friends' joy albums",
	...
	'tidypics:enablephotos' => 'Enable group joy albums module',
	...
	'tidypics:albums' => 'Joy albums',
	'tidypics:album:nosuccess' => 'No joys have been added to this album yet.',
	...
	'tidypics:settings:site_menu_albums' => "All joy albums page",
	...
	'tidypics:settings:album_river_view' => "Show the album cover or a set of joys for new album?",
	'tidypics:settings:river_album_number' => "Maximum number of joys shown in a set on new albums:",
	...
	'tidypics:option:river_comments_thumbnails_small' => "Preview in album view joy size",
	...
	'tidypics:settings:smallsize' => "Album view joys size (px):",
	...
	'tidypics:option:cover' => 'Album cover joy',
	...
	'album:tags' => "Tags",
	'album:cover' => "Make this joy the album cover?",
	...
	'tidypics:sort:instruct' => 'Sort the album joys by dragging and dropping the joys. Then click the save button.',
	...
	'tidypics:album_select:no_results' => 'Sorry, but there are no albums that you can upload joys to and you have no permission to create a new album.',
...
The photo can be viewed here: %s",
	...
	// Widgets
	'widgets:album_view:name' => "Joys Albums",
	'widgets:album_view:description' => "Showcase your joy albums",
	...
	'tidypics:widget:no_albums' => "No joys albums available yet.",

	// River
	'river:object:album:create' => "%s created a new joy album %s",
	'river:object:image:created' => "%s added the joy %s to the album %s",
	...
	'river:object:tidypics_batch:created' => "%s added the joy %s to the album %s",
	'river:object:tidypics_batch:created_single_entry' => "%s added the joy %s and %s more to the album %s",
	'river:object:tidypics_batch:multiple' => "%s added %u joys to the album %s",
	'river:object:comment:image' => '%s commented on the joy %s',
	'river:object:comment:album' => '%s commented on the album %s',

	// Notifications
	'tidypics:newalbum_subject' => 'New joy album',
	'tidypics:newalbum' => '%s created a new joy album',
	'tidypics:updatealbum_subject' => 'New joys in album',
	'tidypics:updatealbum' => "%s uploaded new joys to the album %s",

	'tidypics:notify:summary_newalbum' => 'New joy album called %s',
	'tidypics:notify:subject_newalbum' => 'New joy album: %s',
	'tidypics:notify:body_newalbum' => '%s created a new joy album: %s

View and comment on the album:
%s',

	'tidypics:notify:summary_updatealbum' => 'New joys in album %s',
	'tidypics:notify:subject_updatealbum' => 'New joys in album: %s',
	'tidypics:notify:body_updatealbum' => '%s uploaded new joys to the album %s
...
%s',
	...
	'tidypics:album:could_not_sort' => 'Could not sort the album %s. Make sure there are joys in the album and try again.',
	...
	'tidypics:nosettings' => "Admin of this site has not set joy album settings.",
