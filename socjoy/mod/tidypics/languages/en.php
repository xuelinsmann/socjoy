...
return [
	...
	'photos:addphotos' => "Share joys",
	'images:upload' => "Upload joys to this moment",

	'collection:object:album' => "Joy moments",
	'collection:object:album:owner' => "%s's joy moments",
	'collection:object:album:group' => "Group joy moments",
	'sort:object:album' => 'Sorting the %s moment',
	'add:object:album' => "Describe your joy moment, you will be able to upload your joy next.",
	'collection:object:image' => "Joys",
	'collection:object:image:owner' => "%s's Joys",
	'collection:object:image:group' => "Group joys",
	'collection:object:image:tagged' => "Joys you are tagged in",
	'add:object:image' => "Add joys to moment",
	'edit:object:album' => "Edit moment",
	'edit:object:image' => "Edit joy",
	'edit:object:tidypics_batch' => 'Edit Joy Properties',
	'collection:object:tidypics_batch' => "Joy uploads",
	'collection:object:album:all' => "All joy moments",
	'collection:object:image:all' => 'All joys',
	'collection:object:image:mostviewed' => 'Most viewed joys',
	...
	'collection:object:image:mostcommented' => 'Most commented joys',
	...
	'collection:object:image:recentlyviewed' => 'Recently viewed joys',
	'collection:object:image:recentlycommented' => 'Recently commented joys',
	'collection:object:image:highestrated' => "Highest rated joys",
	'collection:object:image:highestvotecount' => "Most rated joys",
	'collection:object:image:recentlyvoted' => "Recently rated joys",

	'album:slideshow' => "Slideshow",
	'album:yours:friends' => "Your friends' joy moments",
	'item:object:image' => "Joys",
	'item:object:album' => "Moments",
	'item:object:tidypics_batch' => "Joy uploads",
	'tidypics:uploading:images' => "Please wait. Uploading joys.",
	'tidypics:enablephotos' => 'Enable group joy moments module',
	'tidypics:enable_group_images' => 'Enable group joys module',
	'tidypics:mostcommented:nosuccess' => 'There haven\'t been any joys commented yet.',
	'tidypics:mostcommentedthismonth:nosuccess' => 'There haven\'t been any joys commented yet this month.',
	'tidypics:mostcommentedlastmonth:nosuccess' => 'There were no joys commented last month.',
	'tidypics:mostcommentedthisyear:nosuccess' => 'There haven\'t been any joys commented yet this year.',
	'tidypics:mostcommentedtoday:nosuccess' => 'There haven\'t been any joys commented yet today.',
	'tidypics:mostviewed:nosuccess' => 'No joys have been viewed on this site yet.',
	'tidypics:mostviewedthisyear:nosuccess' =>  'No joys have been viewed yet this year.',
	'tidypics:mostviewedthismonth:nosuccess' => 'No joys have been viewed yet this month.',
	'tidypics:mostviewedlastmonth:nosuccess' => 'No joys were viewed last month.',
	'tidypics:mostviewedtoday:nosuccess' => 'No joys have been viewed yet today.',
	...
	'tidypics:albums' => 'Joy moments',
	'tidypics:album:nosuccess' => 'No joys have been added to this moment yet.',
	'tidypics:siteimagesall:nosuccess' => 'There are not yet any joys on this site.',
	'tidypics:siteimagesowner:nosuccess' => 'You have not uploaded any joys yet.',
	'tidypics:siteimagesfriends:nosuccess' => 'Your friends have not uploaded any joys yet.',
	'tidypics:siteimagesgroup' => "%s's joys",
	'tidypics:siteimagesgroup:nosuccess' => 'There have not been uploaded any joys to this group yet.',
	'tidypics:albums_mostrecent' => 'Most recent moments',
	'tidypics:yourmostviewed' => 'Your most viewed joys',
	'tidypics:yourmostrecent' => 'Your most recent joys',
	'tidypics:friendmostviewed' => "%s's most viewed joys",
	'tidypics:friendmostrecent' => "%s's most recent joys",
	'tidypics:highestrated:nosuccess' => "There have no joys been rated yet.",
	'tidypics:highestvotecount:nosuccess' => "There have no joys been rated yet.",
	'tidypics:recentlyvoted:nosuccess' => "There have no joys been rated yet.",
	...
	'tidypics:nophotosingroup' => 'This groups does not have any joys yet.',
	'tidypics:upgrade' => 'Upgrade',
	'tidypics:none' => 'No joy moments',
	...
	'tidypics:settings:tagging' => "Enable joy tagging",
	'tidypics:settings:restrict_tagging' => "If tagging is enabled, allow tagging only to owner of a joy (and admins)",
	...
	'tidypics:settings:grp_perm_override' => "Allow group members full access to group moments",
	'tidypics:settings:site_menu_link' => "Site menu entry target?",
	'tidypics:settings:site_menu_photos' => "All joys page",
	'tidypics:settings:site_menu_albums' => "All joy moments page",
	...
	'tidypics:settings:img_river_view' => "How many entries in activity river for each batch of uploaded joys?",
	'tidypics:settings:album_river_view' => "Show the moment cover or a set of joys for new moment?",
	'tidypics:settings:river_album_number' => "Maximum number of joys shown in a set on new moments:",
	'tidypics:settings:river_comments_thumbnails' => "Include a preview image in activity river entries when moments and images are commented on?",
	'tidypics:settings:river_thumbnails_size' => "Size of the preview images in river entries (if previews are to be displayed)?",
	'tidypics:option:river_comments_thumbnails_small' => "Preview in moment view joy size",
	'tidypics:option:river_comments_thumbnails_tiny' => "Preview in thumbnail joy size",
	...
	'tidypics:settings:river_tags' => "Should an entry in the activity river be created on tagging of a joy?",
	'tidypics:settings:largesize' => "Primary joys size (px):",
	'tidypics:settings:smallsize' => "Moment view joys size (px):",
	'tidypics:settings:tinysize' => "Thumbnail joys size (px):",
	...
	'tidypics:settings:im_id' => "Joy ID",
	...
	'tidypics:option:all' => 'A separate entry for each uploaded joy',
	'tidypics:option:single' => 'One entry with only the first joy of the batch',
	'tidypics:option:batch' => 'One entry with all joys of the batch',
	'tidypics:option:none' => 'No activity river entry',
	'tidypics:option:cover' => 'Moment cover',
	'tidypics:option:set' => 'A set of joys',
	...
	'tidypics:settings:resize_thumbnails_instructions' => "The thumbnails for all currently available joys are re-created using the currently defined thumbnail sizes (see \"Settings\" tab). WARNING: depending on the number of photos on your site this may take a VERY LONG TIME! <b>Please make a backup of the site's database and data directory in any case before starting!</b>",
	'tidypics:settings:resize_thumbnails_count' => "The thumbnails of %s joys in total will get re-created.",
	'tidypics:settings:resize_thumbnails_start' => "Start re-creation of all thumbnails",
	'tidypics:resize_thumbnails:success_processed' => "Number of successfully processed joys: ",
	'tidypics:resize_thumbnails:error_invalid_image_info' => "Number of processed joys with invalid image data: ",
	'tidypics:resize_thumbnails:error_recreate_failed' => "Number of processed joys where re-creation of thumbnails failed: ",
	'tidypics:resize_thumbnails:finished' => "The re-recreation of thumbnails of all %s joys has been finished successfully.",
	...
	'tidypics:server_info:upload_max_filesize_desc' => 'Max size of an uploaded joy file',
	'tidypics:server_info:post_max_size_desc' => 'Max post size = sum of joys + html form',
	...
	// Actions
	'album:create' => "Create new moment",
	'album:delete' => "Delete moment",
	'album:sort' => "Sort",
	'image:delete' => "Delete joy",
	'image:download' => "Download joy",

	// Forms
	'album:title' => "Title",
	'album:desc' => "Description",
	'album:tags' => "Tags",
	'album:cover' => "Make this joy the moment cover?",
	...
	'tidypics:uploader:choose' => "Choose joys",
	'tidypics:uploader:upload' => "Upload joys",
	'tidypics:uploader:describe' => "Describe joys",
	'tidypics:uploader:instructs' => 'There are three easy steps for adding joys to your moment using this uploader: on this page you need to choose the photos to be uploaded first and then upload them in a second step. After the upload has finished you will be automatically redirected to a new page where you can enter titles and descriptions for the uploaded photos as the last step.<br><br> You can upload up to %s photos at a time (%s MB maximum per photo).',
	'tidypics:uploader:basic' => 'You can upload up to %s joys at a time (%s MB maximum per joy). After the upload of the selected photos is finished you will be redirected to a new page where you can enter titles and descriptions for the uploaded photos.',
	'tidypics:sort:instruct' => 'Sort the moment joys by dragging and dropping the joys. Then click the save button.',
	'tidypics:sort:no_images' => 'No joys found to sort. Upload joys using the link above.',
	'tidypics:album_select' => 'Select moment or create new moment:',
	'tidypics:album_select_help' => '(Before you can start with uploading your joys you need to select one of your albums you want to add the photos to or you can select to create a new album.)',
	'tidypics:album_select:no_results' => 'Sorry, but there are no moments that you can upload joys to and you have no permission to create a new album.',
	'tidypics:continue' => 'Continue',
	'tidypics:uploader:filetype' => 'Allowed image file types',

	// Albums
	'album:created_by' => 'By ',
	'album:num' => 'with %s joys',

	// Views
	'image:total' => "Joys in album:",
	'image:by' => "Joy added by",
	'album:by' => "Album created by",
	'album:created:on' => "Created",
	'image:none' => "No joys have been added yet.",
	'image:back' => "Previous",
	'image:next' => "Next",
	'image:index' => "%u of %u",
	...
	'tidypics:tagthisphoto' => 'Tag this joy',
	...
	'tidypics_tagged_members' => "Tagged members in this joys",
	'tidypics:usertags_photos:nosuccess' => "You have not yet been tagged in any joys.",
	'tidypics:phototagging:success' => 'Joy tag was successfully added.',
	'tidypics:phototagging:nosuccess' => 'Joy tag failed because there was no tag entered or all entered tags were duplicates of existing tags.',
	'tidypics:phototagging:success_partly' => 'Joy tag was successfully added but the duplicate word tags were omitted.',
	'tidypics:phototagging:error' => 'Unexpected error occurred during tagging.',

	'tidypics:phototagging:delete:success' => 'Joy tag was removed.',
	'tidypics:phototagging:delete:error' => 'Unexpected error occurred when removing joy tag.',
	'tidypics:phototagging:delete:confirm' => 'Remove this tag?',

	'tidypics:tag:subject' => "You have been tagged in a joy",
	'tidypics:tag:body' => "You have been tagged in the joy %s by %s.

The photo can be viewed here: %s",

	// RSS
	'tidypics:posted' => 'posted a joy:',

	// Widgets
	'widgets:album_view:name' => "Joys Moments",
	'widgets:album_view:description' => "Showcase your joy moments",
	'widgets:latest_photos:name' => "Latest Joys",
	'widgets:latest_photos:description' => "Display your latest joys",
	'widgets:index_latest_photos:name' => 'Most recent images',
	'widgets:index_latest_photos:description' => 'This widget lists the most recent joys uploaded to the site.',
	'widgets:index_latest_albums:name' => 'Most recent moments',
	'widgets:index_latest_albums:description' => 'This widget lists the most recent moments created on the site.',
	'widgets:groups_latest_photos:name' => 'Most recent images',
	'widgets:groups_latest_photos:description' => 'This widget lists the most recent joys uploaded to the site.',
	'widgets:groups_latest_albums:name' => 'Most recent moments',
	'widgets:groups_latest_albums:description' => 'This widget lists the most recent moments created on the site.',
	'tidypics:widget:num_albums' => "Number of moments to display",
	'tidypics:widget:num_latest' => "Number of joys to display",
	'album:more' => "View all albums",
	'tidypics:widget:no_images' => "No joys available yet.",
	'tidypics:widget:no_albums' => "No joys moments available yet.",

	// River
	'river:object:album:create' => "%s created a new joy moment %s",
	'river:object:image:created' => "%s added the joy %s to the moment %s",
	'river:object:image:tagged' => "%s tagged %s in the joy %s",
	'river:object:image:wordtagged' => '%s added new tags to the joy %s',
	'river:object:image:wordtagged_single' => '%s added a new tag to the joy %s',
	'river:object:tidypics_batch:created' => "%s added the joy %s to the moment %s",
	'river:object:tidypics_batch:created_single_entry' => "%s added the joy %s and %s more to the moment %s",
	'river:object:tidypics_batch:multiple' => "%s added %u joys to the moment %s",
	'river:object:comment:image' => '%s commented on the joy %s',
	'river:object:comment:album' => '%s commented on the moment %s',

	// Notifications
	'tidypics:newalbum_subject' => 'New joy moment',
	'tidypics:newalbum' => '%s created a new joy moment',
	'tidypics:updatealbum_subject' => 'New joys in moment',
	'tidypics:updatealbum' => "%s uploaded new joys to the moment %s",

	'tidypics:notify:summary_newalbum' => 'New joy moment called %s',
	'tidypics:notify:subject_newalbum' => 'New joy moment: %s',
	'tidypics:notify:body_newalbum' => '%s created a new joy moment: %s

View and comment on the album:
%s',

	'tidypics:notify:summary_updatealbum' => 'New joys in moment %s',
	'tidypics:notify:subject_updatealbum' => 'New joys in moment: %s',
	'tidypics:notify:body_updatealbum' => '%s uploaded new joys to the moment %s

View and comment on the album:
%s',

	// Status messages
	'tidypics:upl_success' => "Your joys uploaded successfully.",
	'image:saved' => "Your joy was successfully saved.",
	'images:saved' => "All joys were successfully saved.",
	'image:deleted' => "Your joy was successfully deleted.",
	'image:delete:confirm' => "Are you sure you want to delete this joy?",
	'images:edited' => "Your joys were successfully updated.",
	...
	'album:delete:confirm' => "Are you sure you want to delete this moment?",
	...
	'tidypics:album:could_not_sort' => 'Could not sort the moment %s. Make sure there are joys in the album and try again.',
	...
	'tidypics:partialuploadfailure' => "There were errors uploading some of the joys (%s of %s joys).",
	'tidypics:completeuploadfailure' => "Upload of joys failed.",
	'tidypics:exceedpostlimit' => "Too many large joys - try to upload fewer or smaller joys.",
	'tidypics:exceedmax_number' => "Uploading is limited to a maximum number of %s joys at once.",
	'tidypics:noimages' => "No joys were selected.",
	'tidypics:image_mem' => "Joy is too large - too many bytes.",
	'tidypics:image_pixels' => "Joy has too many pixels.",
	...
	'tidypics:nosettings' => "Admin of this site has not set joy moment settings.",
	'tidypics:exceed_quota' => "You have exceeded the quota set by the administrator.",
	'tidypics:cannot_upload_exceeds_quota' => 'Joy not uploaded. File size exceeds available quota.',

	'album:none' => "No moments have been created yet.",
	'album:error' => "An error occured on creating the moment.",
	'album:uploadfailed' => "Sorry; we could not save your moment.",
	'album:deletefailed' => "Your moment could not be deleted.",
	'album:blank' => "Please give this moment a title.",
	'album:invalid_album' => 'Invalid moment',
	'album:cannot_save_cover_image' => 'Cannot save cover image.',

	'image:downloadfailed' => "Sorry; this joy is not available.",
	'images:notedited' => "Not all joys were successfully updated.",
	'image:blank' => 'Please give this joy a title.',
	'image:error' => 'Could not save joy.',
